...
const AboutPage = () => {
  return (
    <div className={styles.wrapper}>
      ...
      <ul>
        <li><Link href="https://www.linkedin.com/in/roshan-roy-8a960b270"><FaLinkedin /></Link></li>
        <li><Link href="https://www.instagram.com/rosshhaan__?igsh=YTQwZjQ0NmI0OA=="><FaInstagram /></Link></li>
        <li><Link href="https://github.com/Roshan-Roy"><FaGithub /></Link></li>
      </ul>
    </div>
  )
}
